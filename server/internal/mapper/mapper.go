...
type Config struct {
	...
	IntervalMs int  `yaml:"interval_ms" json:"interval_ms"` // 全局：每引擎两次请求最小间隔毫秒（0=用内置默认，防 429 限流）
	...
	FOFAIntervalMs int    `yaml:"fofa_interval_ms" json:"fofa_interval_ms"` // 引擎级请求间隔（优先于全局）
	...
	QuakeIntervalMs int    `yaml:"quake_interval_ms" json:"quake_interval_ms"`
	...
	ShodanIntervalMs int    `yaml:"shodan_interval_ms" json:"shodan_interval_ms"`
	...
	ZeroZoneIntervalMs int    `yaml:"zerozone_interval_ms" json:"zerozone_interval_ms"`
	...
	ZoomEyeIntervalMs int    `yaml:"zoomeye_interval_ms" json:"zoomeye_interval_ms"`
}
